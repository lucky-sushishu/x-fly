...
/* USER CODE BEGIN PD */
#define LED_WORK_SET()							HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, GPIO_PIN_RESET)
#define LED_WORK_CLR()							HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, GPIO_PIN_SET)
#define LED_ERROR_SET()							HAL_GPIO_WritePin(GPIOD, GPIO_PIN_13, GPIO_PIN_RESET)
#define LED_ERROR_CLR()							HAL_GPIO_WritePin(GPIOD, GPIO_PIN_13, GPIO_PIN_SET)
